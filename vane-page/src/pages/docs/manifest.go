...
// ("" is the overview index itself). A slug without its own router.Route in
// App.vane falls through to the catch-all route and renders through Stub,
// which links out to the docs source directory on GitHub.
type Topic struct {
	Slug     string
	Title    string
	Summary  string
...
var Manifest = []Topic{
	{Slug: "", Title: "Overview", Summary: "What Vane is and how the pieces fit together.", Category: "Getting Started"},
	{Slug: "concepts", Title: "Concepts", Summary: "The mental model: components, signals, no virtual DOM.", Category: "Getting Started"},
	...
	{Slug: "store", Title: "Global Store", Summary: "Package-level signals for shared state.", Category: "Data & Navigation"},
	{Slug: "refs-and-dom", Title: "Refs & DOM", Summary: "Reading and imperatively touching DOM nodes.", Category: "Data & Navigation"},

	{Slug: "lifecycle", Title: "Lifecycle", Summary: "Mount, effect reruns, cleanup, and signal lifetime.", Category: "Advanced"},
	...
	{Slug: "patterns", Title: "Patterns", Summary: "Patterns for common UI problems.", Category: "How-to Patterns"},
