...
func compressWasmSize(path string) (int64, error) {
	data, err := os.ReadFile(path) // #nosec G304 -- path is an internally constructed build output path under the selected project directory
	if err != nil {
		return 0, err
	}
